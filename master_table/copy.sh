...
aws s3 sync s3://serratus-public/assemblies/annotations/   . --exclude "*" --include "*.darth.stripped.tar.gz"
aws s3 sync s3://serratus-public/assemblies/annotations/   . --exclude "*" --include "*.darth.alignments.fasta"
